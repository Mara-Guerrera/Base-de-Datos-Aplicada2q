...
SELECT c.nombre nombre_categoria,tp.nombre tipo_producto FROM gestion_producto.Categoria c
INNER JOIN gestion_producto.TipoProducto tp ON c.id_tipoProducto = tp.id
