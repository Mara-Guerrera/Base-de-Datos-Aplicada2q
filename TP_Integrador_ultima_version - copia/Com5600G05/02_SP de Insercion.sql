...
BEGIN
    ...
    BEGIN
        RAISERROR('El género no es válido',16,1);
        RETURN;
    END
	...
	BEGIN
		RAISERROR('El formato del CUIT no es válido.',16,1);
		RETURN;
	END
	...
	INSERT INTO gestion_sucursal.Cliente (nombre, apellido, id_tipo, id_genero,dni,direccion)
	VALUES (@name, @surname, @type, @gender,@dni,@domicilio);
